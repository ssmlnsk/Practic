...
class Database:
    def __init__(self):
        try:
            self.conn = mysql.connector.connect(host='localhost', port=3306, user='root', password='Morphex', database='igora')
    ...
    def get_serv_id(self, name):
        try:
            self.conn = mysql.connector.connect(host='localhost', port=3306, user='root', password='Morphex',
                                                database='igora')
            cursor = self.conn.cursor()
